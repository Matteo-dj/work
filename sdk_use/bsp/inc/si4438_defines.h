#ifndef _SI4438_DEFINES_H_
#define _SI4438_DEFINES_H_

#define RADIO_DELAY_CNT_AFTER_RESET                                            1000
#define CMDINDEX                                                               4
#define CMD_CTS                                                                0x44
#define REPLY_CTS                                                              0XFF
#define RADIO_ANSWER_CTS_COUNT                                                 2500
#define READ_PART_INFO_COUNT                                                   2
#define SEND_CMD_COUNT                                                         16
#define GET_REPLY_COUNT                                                        16
#define RF_CHIP_VERSION_MSB                                                    0x44
#define RF_CHIP_VERSION_LSB                                                    0x38
#define SI4438_CHIPREV_C2                                                      0x22
#define SI4438_CHIPREV_B1                                                      0x11
#define SI4438_B1                                                              1
#define SI4438_C2                                                              2

#define PA_RX_BYPASS                                                           0
#define PA_TX_BYPASS                                                           1
#define PA_RX                                                                  2
#define PA_TX                                                                  3
#define PA_MODE_PARAM_NUM                                                      8

#define RF_GPIO_HIGH_LEVEL                                                     0x43
#define RF_GPIO_LOW_LEVEL                                                      0x42
#define RF_GPIO_DEFAULT                                                        0
...
typedef struct
{
    ...
    HI_U8  chip_pend;
    HI_U8  chip_status;
}REPLY_GET_INT_STATUS_MAP;

typedef struct  {
    HI_U16 afc_freq_offset;
    HI_U8  modem_pend;
    HI_U8  modem_status;
    HI_U8  curr_rssi;
    HI_U8  latch_rssi;
...
typedef struct  {
    ...
    HI_U8  part_lsb;//38
    HI_U8  pbuild;//芯片小版本
    HI_U8  id_msb;//厂家内部ID，与用户无关
    HI_U8  id_lsb;
    HI_U8  customer;//厂家内部ID，与用户无关
    HI_U8  romid;//这个判断不准确
    HI_U8  bond;//无需定义，去掉
    HI_U8  rsvd[3];
}REPLY_PART_INFO_MAP;
...
{
    HI_U8  curr_state;
    HI_U8  current_channel;
    HI_U8  rsvd[2];
}REPLY_REQUEST_DEVICE_STATE_MAP;
...
//PART_INFO REPLY
#define SI446X_CMD_REPLY_COUNT_PART_INFO                                       8
    #define SI446X_CMD_PART_INFO_REP_CHIPREV_TYPE HI_U8
    ...
    #define SI446X_CMD_PART_INFO_REP_PART_TYPE HI_U16
    ...
    #define SI446X_CMD_PART_INFO_REP_PBUILD_TYPE HI_U8
    ...
    #define SI446X_CMD_PART_INFO_REP_ID_TYPE HI_U16
    ...
    #define SI446X_CMD_PART_INFO_REP_CUSTOMER_TYPE HI_U8
    ...
    #define SI446X_CMD_PART_INFO_REP_ROMID_TYPE HI_U8
...
#define SI446X_CMD_ARG_COUNT_POWER_UP                                          7
    ...
    #define SI446X_CMD_POWER_UP_ARG_XO_FREQ_TYPE HI_U32
...
#define SI446X_CMD_REPLY_COUNT_FUNC_INFO                                       6
    #define SI446X_CMD_FUNC_INFO_REP_REVEXT_TYPE HI_U8
    ...
    #define SI446X_CMD_FUNC_INFO_REP_REVBRANCH_TYPE HI_U8
    ...
    #define SI446X_CMD_FUNC_INFO_REP_REVINT_TYPE HI_U8
    ...
    #define SI446X_CMD_FUNC_INFO_REP_PATCH_TYPE HI_U16
    ...
    #define SI446X_CMD_FUNC_INFO_REP_FUNC_TYPE HI_U8
...
#define SI446X_CMD_ARG_COUNT_SET_PROPERTY                                      16
    #define SI446X_CMD_SET_PROPERTY_ARG_GROUP_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_NUM_PROPS_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_START_PROP_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_DATA0_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_DATA1_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_DATA2_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_DATA3_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_DATA4_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_DATA5_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_DATA6_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_DATA7_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_DATA8_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_DATA9_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_DATA10_TYPE HI_U8
    ...
    #define SI446X_CMD_SET_PROPERTY_ARG_DATA11_TYPE HI_U8
...
//GET_PROPERTY ARGS
#define SI446X_CMD_ARG_COUNT_GET_PROPERTY                                      4
    #define SI446X_CMD_GET_PROPERTY_ARG_GROUP_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_ARG_NUM_PROPS_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_ARG_START_PROP_TYPE HI_U8
...
#define SI446X_CMD_REPLY_COUNT_GET_PROPERTY                                    16
    #define SI446X_CMD_GET_PROPERTY_REP_DATA0_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA1_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA2_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA3_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA4_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA5_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA6_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA7_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA8_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA9_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA10_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA11_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA12_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA13_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA14_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_PROPERTY_REP_DATA15_TYPE HI_U8
...
#define SI446X_CMD_REPLY_COUNT_GET_ADC_READING                                 8
    #define SI446X_CMD_GET_ADC_READING_REP_GPIO_ADC_TYPE HI_U16
    ...
    #define SI446X_CMD_GET_ADC_READING_REP_BATTERY_ADC_TYPE HI_U16
    ...
    #define SI446X_CMD_GET_ADC_READING_REP_TEMP_ADC_TYPE HI_U16
    ...
    #define SI446X_CMD_GET_ADC_READING_REP_TEMP_SLOPE_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_ADC_READING_REP_TEMP_INTERCEPT_TYPE HI_U8
...
//FIFO_INFO REPLY
#define SI446X_CMD_REPLY_COUNT_FIFO_INFO                                       2
    #define SI446X_CMD_FIFO_INFO_REP_RX_FIFO_COUNT_TYPE HI_U8
    ...
    #define SI446X_CMD_FIFO_INFO_REP_TX_FIFO_SPACE_TYPE HI_U8
...
#define SI446X_CMD_ARG_COUNT_PACKET_INFO                                       6
    ...
    #define SI446X_CMD_PACKET_INFO_ARG_LEN_TYPE HI_U16
    ...
    #define SI446X_CMD_PACKET_INFO_ARG_LEN_value //((//(cmd.arg.RAW_HI_U16[1])))
...
#define SI446X_CMD_REPLY_COUNT_PACKET_INFO                                     2
    #define SI446X_CMD_PACKET_INFO_REP_LENGTH_15_8_TYPE HI_U8
    ...
    #define SI446X_CMD_PACKET_INFO_REP_LENGTH_7_0_TYPE HI_U8
...
#define SI446X_CMD_REPLY_COUNT_IRCAL                                           3
    #define SI446X_CMD_IRCAL_REP_CAL_STATE_TYPE HI_U8
    ...
    #define SI446X_CMD_IRCAL_REP_RSSI_TYPE HI_U8
    ...
    #define SI446X_CMD_IRCAL_REP_DIR_CH_TYPE HI_U8
...
#define SI446X_CMD_ARG_COUNT_PROTOCOL_CFG                                      2
    #define SI446X_CMD_PROTOCOL_CFG_ARG_PROTOCOL_TYPE HI_U8
...
#define SI446X_CMD_REPLY_COUNT_GET_MODEM_STATUS                                8
    ...
    #define SI446X_CMD_GET_MODEM_STATUS_REP_CURR_RSSI_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_MODEM_STATUS_REP_LATCH_RSSI_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_MODEM_STATUS_REP_ANT1_RSSI_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_MODEM_STATUS_REP_ANT2_RSSI_TYPE HI_U8
    ...
    #define SI446X_CMD_GET_MODEM_STATUS_REP_AFC_FREQ_OFFSET_TYPE HI_U16
...
#define SI446X_CMD_REPLY_COUNT_GET_CHIP_STATUS                                 3
    ...
    #define SI446X_CMD_GET_CHIP_STATUS_REP_CMD_ERR_STATUS_TYPE HI_U8
...
//START_TX ARGS
#define SI446X_CMD_ARG_COUNT_START_TX                                          6
    #define SI446X_CMD_START_TX_ARG_CHANNEL_TYPE HI_U8
    ...
    #define SI446X_CMD_START_TX_ARG_TX_LEN_TYPE HI_U16
    ...
    #define SI446X_CMD_START_TX_ARG_TX_LEN_value //((//(cmd.arg.RAW_HI_U16[1])))
    #define SI446X_CMD_START_TX_ARG_TX_LEN_MIN 0
    #define SI446X_CMD_START_TX_ARG_TX_LEN_MAX 8191
    #define SI446X_CMD_START_TX_ARG_TX_DELAY_TYPE HI_U8
...
//START_RX ARGS
#define SI446X_CMD_ARG_COUNT_START_RX                                          8
    #define SI446X_CMD_START_RX_ARG_CHANNEL_TYPE HI_U8
    ...
    #define SI446X_CMD_START_RX_ARG_RX_LEN_TYPE HI_U16
    ...
    #define SI446X_CMD_START_RX_ARG_RX_LEN_value //((//(cmd.arg.RAW_HI_U16[1])))
...
#define SI446X_CMD_REPLY_COUNT_REQUEST_DEVICE_STATE                            2
    ...
    #define SI446X_CMD_REQUEST_DEVICE_STATE_REP_CURRENT_CHANNEL_TYPE HI_U8
...
#define SI446X_CMD_ARG_COUNT_START_MFSK                                        4
    ...
    #define SI446X_CMD_START_MFSK_ARG_FREQ_OFFSET_TYPE HI_U16
    ...
    #define SI446X_CMD_START_MFSK_ARG_FREQ_OFFSET_value //((//(cmd.arg.RAW_HI_U16[1])))
//START_MFSK REPLY
...
#define SI446X_CMD_ARG_COUNT_RX_HOP                                            7
    #define SI446X_CMD_RX_HOP_ARG_INTE_TYPE HI_U8
    ...
    #define SI446X_CMD_RX_HOP_ARG_FRAC2_TYPE HI_U8
    ...
    #define SI446X_CMD_RX_HOP_ARG_FRAC1_TYPE HI_U8
    ...
    #define SI446X_CMD_RX_HOP_ARG_FRAC0_TYPE HI_U8
    ...
    #define SI446X_CMD_RX_HOP_ARG_VCO_CNT1_TYPE HI_U8
    ...
    #define SI446X_CMD_RX_HOP_ARG_VCO_CNT0_TYPE HI_U8
...
#define SI446X_CMD_REPLY_COUNT_READ_CMD_BUFF                                   16
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF0_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF1_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF2_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF3_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF4_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF5_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF6_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF7_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF8_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF9_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF10_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF11_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF12_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF13_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF14_TYPE HI_U8
    ...
    #define SI446X_CMD_READ_CMD_BUFF_REP_CMD_BUFF15_TYPE HI_U8
...
#define SI446X_CMD_REPLY_COUNT_FRR_A_READ                                      3
    #define SI446X_CMD_FRR_A_READ_REP_FRR_B_VALUE_TYPE HI_U8
    ...
    #define SI446X_CMD_FRR_A_READ_REP_FRR_C_VALUE_TYPE HI_U8
    ...
    #define SI446X_CMD_FRR_A_READ_REP_FRR_D_VALUE_TYPE HI_U8
...
#define SI446X_CMD_REPLY_COUNT_FRR_B_READ                                      3
    #define SI446X_CMD_FRR_B_READ_REP_FRR_C_VALUE_TYPE HI_U8
    ...
    #define SI446X_CMD_FRR_B_READ_REP_FRR_D_VALUE_TYPE HI_U8
    ...
    #define SI446X_CMD_FRR_B_READ_REP_FRR_A_VALUE_TYPE HI_U8
...
#define SI446X_CMD_REPLY_COUNT_FRR_C_READ                                      3
    #define SI446X_CMD_FRR_C_READ_REP_FRR_D_VALUE_TYPE HI_U8
    ...
    #define SI446X_CMD_FRR_C_READ_REP_FRR_A_VALUE_TYPE HI_U8
    ...
    #define SI446X_CMD_FRR_C_READ_REP_FRR_B_VALUE_TYPE HI_U8
...
#define SI446X_CMD_REPLY_COUNT_FRR_D_READ                                      3
    #define SI446X_CMD_FRR_D_READ_REP_FRR_A_VALUE_TYPE HI_U8
    ...
    #define SI446X_CMD_FRR_D_READ_REP_FRR_B_VALUE_TYPE HI_U8
    ...
    #define SI446X_CMD_FRR_D_READ_REP_FRR_C_VALUE_TYPE HI_U8
...
#define SI446X_CMD_ARG_COUNT_WRITE_TX_FIFO                                     2
    #define SI446X_CMD_WRITE_TX_FIFO_ARG_FIRST_BYTE_TYPE HI_U8
