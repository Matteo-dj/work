...
#define HI_SIZE_T HI_U32

// for test
//#define DRV_DEBUG
#ifndef DRV_DEBUG
#define HI_ERR_CIPHER(_fmt, arg...)
#define HI_FATAL_CIPHER(_fmt, arg...)
#define HI_WARN_CIPHER(_fmt, arg...)
#define HI_INFO_CIPHER(_fmt, arg...)
#define HI_DEBUG_CIPHER(_fmt, arg...)
#else
#define HI_FATAL_CIPHER(_fmt, arg...) \
