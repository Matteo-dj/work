...
#define MDIO_MK_RWCTL(cpu_data_in, finish, rw, phy_exaddr, frq_div, phy_regnum)\
        (((unsigned int)(cpu_data_in)<<16) | \
          (((unsigned int)(finish)&0x01)<<15) | \
          (((unsigned int)(rw)&0x01)<<13) | \
          (((unsigned int)(phy_exaddr)&0x1F)<<8) | \
          (((unsigned int)(frq_div)&0x7)<<5) | \
          ((unsigned int)(phy_regnum)&0x1F))
...
int hieth_mdio_read(struct hieth_netdev_local *ld,
                        unsigned int phy_addr, unsigned int regnum);
