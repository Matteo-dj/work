...
ifeq ($(LOSCFG_PLATFORM_HI3516A), y)
    ...
    LITEOS_CMACRO      += -DLOSCFG_ARM926 -DLOSCFG_PLATFORM_HI3911
...
ifeq ($(LOSCFG_LIB_LIBC), y)
    ...
    LITEOS_LIBC_INCLUDE   += \
        ...
        -I $(LITEOSTOPDIR)/lib/libc/src/stdio \
        -I $(LITEOSTOPDIR)/lib/libc/src/time \
        -I $(LITEOSTOPDIR)/lib/libc/libwc/include \
...
ifeq ($(LOSCFG_FS_YAFFS), y)
    LITEOS_BASELIB  += -lyaffs2 -lmulti_partition
    LIB_SUBDIRS     += fs/yaffs2 fs/vfs/multi_partition
...
ifeq ($(LOSCFG_FS_JFFS), y)
    LITEOS_BASELIB  += -ljffs2 -lmulti_partition
    LIB_SUBDIRS     += fs/jffs2 fs/vfs/multi_partition
    LITEOS_VFS_MTD_INCLUDE := -I $(LITEOSTOPDIR)/fs/vfs/include/multi_partition
...
ifeq ($(LOSCFG_NET_LWIP_SACK), y)
    ...
    LITEOS_CMACRO     +=  -DLOSCFG_NET_LWIP_SACK  $(LWIP_MACROS)
...
ifeq ($(LOSCFG_PLATFORM_OSAPPINIT), y)
    ...
    LITEOS_CMACRO    += -DLOSCFG_TEST -DLOSCFG_KERNEL_USER_ERR_HANDLE
    LITEOS_MINISYS   := y
...
ifeq ($(LOSCFG_COMPILER_HISIV600), y)
    ...
    LITEOS_CXXOPTS_BASE  += -std=c++11 -nostdlib -nostdinc -nostdinc++ -fexceptions -fpermissive -fno-use-cxa-atexit -fno-builtin
endif
...
LITEOS_COPTS_EXTRA := -Wundef  -std=c99 -Wpointer-arith -Wstrict-prototypes \
