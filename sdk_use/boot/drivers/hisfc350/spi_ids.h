...
//-----------------------------------------------------------------------------
#define FLASH_PROTECT_NOT_SUPPORT                   0
#define FLASH_PROTECT_SUPPORT_TYPE_ONE              MAKEU16('O','E')//ONE 0x4f 0x4E   
#define FLASH_PROTECT_SUPPORT_TYPE_TWO              MAKEU16('T','W')//TWO
#define FLASH_PROTECT_SUPPORT_TYPE_THREE            MAKEU16('T','H')//THREE
/*****************************************************************************/
...
struct spi_info
{
    ...
    unsigned short  protecttype;//支持哪一种保护驱动的类型

    unsigned long  chipsize;
    unsigned int   erasesize;
    unsigned int   addrcycle;
#ifdef FLASH_MINI_BOOT
#define MAX_SPI_OP                       (4)
#else
#define MAX_SPI_OP                       (8)
#endif
