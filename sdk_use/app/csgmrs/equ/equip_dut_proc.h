...
typedef enum
{
    RET_CODE_ERR_PARSE = 1,   //解析错误
    RET_CODE_ERR_MAC_ADDRSS,  //获取MAC地址错误
    RET_CODE_ERR_USER_VER,    //获取用户版本错误
    RET_CODE_ERR_SZ,          //获取厂商代码错误
}EQUIP_RET_CODE_ENUM;//错误码枚举

typedef struct _EQUIP_TEST_DUT_INFO_STRU_
{ 
    HI_U8 RltCode;                      // 错误码  参见EQUIP_RET_CODE_ENUM
