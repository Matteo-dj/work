...
typedef enum
{
    MRS_DFX_CCO_UPG_FILE_LOAD_STATUS = 1,
    MRS_DFX_CCO_UPG_LOCAL_UPG_STATUS,
    MRS_DFX_CCO_UPG_NOMAL_FINISH_STATUS,
    MRS_DFX_CCO_UPG_TEN_MINUTE_EXIT_STATUS,
    MRS_DFX_CCO_UPG_START_UPG_FAIL_STATUS,
    MRS_DFX_CCO_UPG_RX_STOP_UPG_STATUS,
}MRS_DFX_CCO_UPG_STATUS_E;  //  升级状态

typedef enum
{
    MRS_DFX_CC0_UPG_REASON_NONE = 0,
    MRS_DFX_CCO_UPG_REASON_TEN_MINUTE_EXIT,
    MRS_DFX_CCO_UPG_REASON_START_UPG_FAIL,
    MRS_DFX_CCO_UPG_REASON_RX_STOP_UPG,
    MRS_DFX_CCO_UPG_REASON_FAILED,  // 失败
    MRS_DFX_CCO_UPG_REASON_QRY_INFO_FAILED, // 查询全部消息失败
    MRS_DFX_CCO_UPG_REASON_QRY_INFO_TIMEOUT,    //查询全部信息超时
    MRS_DFX_CCO_UPG_REASON_PLC_UNAVAILABLE, //PLC不可用超时
    MRS_DFX_CCO_UPG_REASON_OTHER_UPG,   // 存在其他升级
    MRS_DFX_CCO_UPG_REASON_MALLOC_FAILED, //内存分配失败
}MRS_DFX_CCO_CSG_UPG_END_REASON_E;
...
HI_VOID mrsDfxRefreshUpgEndReason(HI_U8 ucEndReason);  // 结束失败原因
#endif
