...
#define  HI_MDM_UNCHECK_MODE            (0)
#define  HI_MDM_CHECK_MODE              (1)
...
#define mrsToolsBroadCastMac(x)         (memcmp(x,MRS_BROADCAST_MAC,6)==0)
...
//获取本模块的MAC
#else
#define MRS_TOOLS_00_TO_FE(a)
#define MRS_TOOLS_FE_TO_00(a)
#endif
...
HI_PUBLIC HI_U32   mrsToolsCheck3762Frame(HI_PBYTE,HI_U16,HI_U16);
...
#define BIT8_SET(x,i)    ((x) = (HI_U8)((((HI_U8)1) << (i)) | (x)))
