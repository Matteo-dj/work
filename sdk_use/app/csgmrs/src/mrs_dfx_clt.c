...
HI_U8 mrsDfxCltiiGetSmAbnormal(HI_VOID)
{
    DIAG_CMD_MRS_GET_CLT_SEARCH_LOCAL_IND_STRU* pstLocal = mrsDfxCltGetSearchLocal();

    return (pstLocal->stProtocol07.ucAbnormal 
        | pstLocal->stProtocol97a.ucAbnormal 
        | pstLocal->stProtocol97b.ucAbnormal
        | g_stCltSearchLocalEx.stProtocol97c.ucAbnormal);
}
