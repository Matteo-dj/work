...
void si446x_power_up(U8 BOOT_OPTIONS, U8 XTAL_OPTIONS, U32 XO_FREQ)
{
    ...
    radio_common_SendCmd( SI446X_CMD_ARG_COUNT_POWER_UP, Pro2Cmd );
}
...
U8 si446x_configuration_init(const U8* pSetPropCmd)
{
  ...
  while (*pSetPropCmd != 0x00)
  {
    ...
    if (radio_common_SendCmdGetResp(numOfBytes, Pro2Cmd, 0, 0) != 0xFF)
    {
      /* Timeout occured */
 ...
 */
u16 si446x_part_info(void)
{
    Pro2Cmd[0] = SI446X_CMD_ID_PART_INFO;

    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_PART_INFO,
                              Pro2Cmd,
...
void si446x_start_tx(U8 CHANNEL, U8 CONDITION, U16 TX_LEN)
{
    ...
    radio_common_SendCmd( SI446X_CMD_ARG_COUNT_START_TX, Pro2Cmd );
}
...
void si446x_start_rx(U8 CHANNEL, U8 CONDITION, U16 RX_LEN, U8 NEXT_STATE1, U8 NEXT_STATE2, U8 NEXT_STATE3)
{
    ...
    radio_common_SendCmd( SI446X_CMD_ARG_COUNT_START_RX, Pro2Cmd );
}
...
void si446x_get_int_status(U8 PH_CLR_PEND, U8 MODEM_CLR_PEND, U8 CHIP_CLR_PEND)
{
    ...
    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_GET_INT_STATUS,
                              Pro2Cmd,
...
void si446x_gpio_pin_cfg(U8 GPIO0, U8 GPIO1, U8 GPIO2, U8 GPIO3, U8 NIRQ, U8 SDO, U8 GEN_CONFIG)
{
    ...
    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_GPIO_PIN_CFG,
                              Pro2Cmd,
...
void si446x_set_property( U8 GROUP, U8 NUM_PROPS, int START_PROP, ... )
{
    ...
    radio_common_SendCmd( cmdIndex, Pro2Cmd );
}
...
void si446x_change_state(U8 NEXT_STATE1)
{
    ...
    radio_common_SendCmd( SI446X_CMD_ARG_COUNT_CHANGE_STATE, Pro2Cmd );
}
...
void si446x_nop(void)
{
    ...
    radio_common_SendCmd( SI446X_CMD_ARG_COUNT_NOP, Pro2Cmd );
}
...
void si446x_fifo_info(U8 FIFO)
{
    ...
    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_FIFO_INFO,
                              Pro2Cmd,
...
{
  radio_common_WriteData( SI446X_CMD_ID_WRITE_TX_FIFO, 0, numBytes, pTxData );
}
...
{
  radio_common_ReadData( SI446X_CMD_ID_READ_RX_FIFO, 0, numBytes, pRxData );
}
...
void si446x_get_property(U8 GROUP, U8 NUM_PROPS, U8 START_PROP)
{
    ...
    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_GET_PROPERTY,
                              Pro2Cmd,
                              Pro2Cmd[2],
                              Pro2Cmd );
...
void si446x_func_info(void)
{
    ...
    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_FUNC_INFO,
                              Pro2Cmd,
...
{
    radio_common_ReadData(SI446X_CMD_ID_FRR_A_READ,
                            0,
                        respByteCount,
                        Pro2Cmd);
...
{
    radio_common_ReadData(SI446X_CMD_ID_FRR_B_READ,
                            0,
                        respByteCount,
                        Pro2Cmd);
...
{
    radio_common_ReadData(SI446X_CMD_ID_FRR_C_READ,
                            0,
                        respByteCount,
                        Pro2Cmd);
...
{
    radio_common_ReadData(SI446X_CMD_ID_FRR_D_READ,
                            0,
                        respByteCount,
                        Pro2Cmd);
...
void si446x_get_adc_reading(U8 ADC_EN)
{
    ...
    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_GET_ADC_READING,
                              Pro2Cmd,
...
void si446x_get_packet_info(U8 FIELD_NUMBER_MASK, U16 LEN, S16 DIFF_LEN )
{
    ...
    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_PACKET_INFO,
                              Pro2Cmd,
...
void si446x_get_ph_status(U8 PH_CLR_PEND)
{
    ...
    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_GET_PH_STATUS,
                              Pro2Cmd,
...
void si446x_get_modem_status( U8 MODEM_CLR_PEND )
{
    ...
    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_GET_MODEM_STATUS,
                              Pro2Cmd,
...
void si446x_get_chip_status( U8 CHIP_CLR_PEND )
{
    ...
    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_GET_CHIP_STATUS,
                              Pro2Cmd,
...
void si446x_ircal(U8 SEARCHING_STEP_SIZE, U8 SEARCHING_RSSI_AVG, U8 RX_CHAIN_SETTING1, U8 RX_CHAIN_SETTING2)
{
    ...
    radio_common_SendCmd( SI446X_CMD_ARG_COUNT_IRCAL, Pro2Cmd);
}
...
void si446x_ircal_manual(U8 IRCAL_AMP, U8 IRCAL_PH)
{
    ...
    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_IRCAL_MANUAL,
                              Pro2Cmd,
...
void si446x_request_device_state(void)
{
    ...
    radio_common_SendCmdGetResp( SI446X_CMD_ARG_COUNT_REQUEST_DEVICE_STATE,
                              Pro2Cmd,
...
void si446x_tx_hop(U8 INTE, U8 FRAC2, U8 FRAC1, U8 FRAC0, U8 VCO_CNT1, U8 VCO_CNT0, U8 PLL_SETTLE_TIME1, U8 PLL_SETTLE_TIME0)
{
    ...
    radio_common_SendCmd( SI446X_CMD_ARG_COUNT_TX_HOP, Pro2Cmd );
}
...
void si446x_rx_hop(U8 INTE, U8 FRAC2, U8 FRAC1, U8 FRAC0, U8 VCO_CNT1, U8 VCO_CNT0)
{
    ...
    radio_common_SendCmd( SI446X_CMD_ARG_COUNT_RX_HOP, Pro2Cmd );
}
...
void si446x_start_tx_fast( void )
{
    ...
    radio_common_SendCmd( 1, Pro2Cmd );
}
...
void si446x_get_ph_status_fast_clear( void )
{
    ...
    radio_common_SendCmd( 2, Pro2Cmd );
}
