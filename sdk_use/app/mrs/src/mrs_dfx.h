...
typedef struct 
{
    ...
    HI_DSID_APP_STA_POWER_ON_OFF_INF_S  app_sta_power_on_off_inf; // STA停上电信息统计
#endif
#if defined(PRODUCT_CFG_PRODUCT_TYPE_CCO)    
    ...
    HI_DSID_APP_CCO_POWER_ON_OFF_INF_S  app_cco_power_on_off_inf; // CCO停上电信息统计
#endif
...
/* END:   PN: DTS2016021906890 MODIFY\ADD\DEL by cuiate/00233580 at 2016/2/21 */
    ...
    HI_DSID_APP_CSG_PYSICAL_MODE_INF_S  app_sta_csg_physicalmode_inf;//获取测试模式相关信息 
#endif
#if defined(PRODUCT_CFG_PRODUCT_TYPE_CCO)    
    PLC_CHL_INF_S                       app_cco_ndm_plc_rx_tx;        //cco接收抄控器plc帧 通道收发统计
#endif
}MRS_DFX_MODULE;
