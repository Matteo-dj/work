...
#define xMRS_LOG_STA_SWITCH  //optimization by weichao  MRS_LOG_STA_SWITCH-->xMRS_LOG_STA_SWITCH
#endif
...
//HI_U32 mrsLogSendDayfreezeRecToHso(HI_U16 usId, HI_IN HI_PVOID pCmdParam,
                                                    //HI_U16 usCmdParamSize, HI_U32 ulOption);//optimized by weichao
//HI_VOID mrsSetFristGetTimeFlg(HI_U8 ucFlag);//optimized by weichao
//HI_BOOL mrsGetCcoTimeFrist(HI_VOID);//optimized by weichao
//HI_VOID mrsGetTimeEndPro(HI_VOID);//optimized by weichao
//HI_BOOL mrsCcoClockStatusAllow(HI_VOID);//optimized by weichao
