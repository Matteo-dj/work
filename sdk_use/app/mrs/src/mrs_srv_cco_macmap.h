...
#define MRS_MAC_MAP_REFRESH_TIME_DEFAULT        (60 * 4)  // CCO端重新刷新映射表间隔时间默认值(单位S)
...
#define MRS_MAC_MAP_MAX_REFRESH_NUM_DEFAULT     (5)  // CCO端重新刷新映射表间隔时间默认值(单位S)
...
{
    HI_U16  bValid  : 1;
    HI_U16  usTTL   : 6;     // Mac-meter map TTL
    HI_U16  usMrTTL : 6;     // Meter-reading TTL
    HI_U16  usPhase : 3;     // only exit stMacMeterMap
