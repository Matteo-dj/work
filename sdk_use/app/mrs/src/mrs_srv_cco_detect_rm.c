...
{
    HI_U32 ulRet = HI_ERR_SUCCESS;
    MRS_3762_USER_DATA_HRD_STRU *pstUsrDataHrd = HI_NULL;//定义为指针，分配内存
...
/**
 @brief  Set detect flow break-stauts.   CNcomment: 设置探测流程被打断状态。CNend
 @param[in] bEnable  0-Disable, 1-Enable.   CNcomment: 0-禁止，1-允许。CNend
 */
...
/**
 @brief  Check whether detect flow is break-stauts.  CNcomment: 检查探测流程是否为被打断状态。CNend
 @retval ::HI_FALSE normal status.   CNcomment: 正常状态。CNend
 @retval ::HI_TRUE  break status.    CNcomment: 打断状态。CNend
 */
