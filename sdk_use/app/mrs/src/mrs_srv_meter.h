...
// 同步虚拟表地址到Mac层
HI_PUBLIC HI_VOID mrsSyncVMAddrToMac(HI_U8 ucProtocol);

HI_U32 mrsStaSend2Meter(MRS_MET_MODULE *,HI_PBYTE, HI_U16, HI_U8);
HI_U32 mrsStaSend2Meter645(MRS_MET_MODULE *,HI_PBYTE, HI_U16);
HI_U32 mrsStaSend2Meter698(MRS_MET_MODULE *,HI_PBYTE, HI_U16);
