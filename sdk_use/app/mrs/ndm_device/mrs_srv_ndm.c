...
HI_VOID APP_NdmInit(HI_VOID)
{
    ...
    g_stAppOsaTimer[MRS_NDM_TIMER_READ_DEV_ID].pFunc         = (APP_NDM_TIMER_PFN)mrs_ndm_plc_read_id_timeout;
...
HI_VOID mrsNdmKeyTestCallback(HI_BOOL bKeyPress, HI_U32 ulMs, HI_U32 ulUserData)
{
    ...
    pstCtx->stEqtCtx.stKeyTest.ulKeyResponse |=  (1 << (HI_U32)eKeyNum);
