...
#define CSG_STG_VER 0		//国网为0，南网为1
#define LOCAL_VER	"BJ"
#define BASE_VER  2
#ifdef SIGNAL_MCU
	#define VER_NO   19
...
#define MRS_SRV_PROTOCOL_CJT188         // 支持CJT188协议

#define PRODUCT_CFG_SUPPORT_MRS_DUOL_MODE_RF

#define PRODUCT_CFG_SUPPORT_MRS_DUOL_MODE_RF_II //扩展的 阶段2 取时隙 命令


#define MRS_SRV_MODULE_ID			//模块ID
#define MRS_SRV_MODULE_ID_LEN 11	//模块ID长度
#define MRS_SRV_MODULE_ID_LEN_MAX 20	//最大支持模块ID长度
